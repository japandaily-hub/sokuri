    ...
    <>
      ...
      <div className={`legal-pane${tab === "user" ? " active" : ""}`} id="pane-user">
        <div className="legal-body">
          ...
          <p>
            氏名・電話番号・詳細住所（番地・建物名など）といった連絡先は、取引交渉が成立した業者にのみ開示されます。査定段階で業者に渡るのは、写真・品目・利用目的・地域（都道府県・市区町村）・住居情報（住居種別・間取り・階数・エレベーターの有無）と、これらに基づくAI要約のみです。
          </p>
          <div className="note">
            連絡が来るのは、ユーザーが選択した成約業者1社のみです。それ以外の業者への連絡先開示・架電は行われません。
          </div>
