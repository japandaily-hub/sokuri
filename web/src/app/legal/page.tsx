  ...
  return (
    <main id="main">
      ...
      <div className="doc-wrap">
        ...
        <div className="doc-meta">最終改定：2026年9月18日</div>
        ...
        <table className="spec-table">
          <tbody>
            ...
            {/* ラウンド4 指摘（High・業者視点）: 「請求があれば開示」が3項目並ぶだけで理由も
                請求方法も書かれておらず、古物商許可証と口座を預ける側には匿名に見えていた。
                掲載しない理由と請求の具体的な窓口（/contact の「事業者情報の開示請求」）を
                1ブロックで添える。掲載内容そのもの（代表者名・番地・電話番号の常時表示、
                独自ドメインのメール）は運営主体の実データが必要なため変更しない。 */}
            <tr>
              <th>代表者名</th>
              <td>
                請求があれば遅滞なく開示します
                <br />
                <span className="note">
                  ※ 個人で運営しているため、代表者名・詳細住所（番地等）・電話番号は常時掲載していません。ご請求は
                  <Link href="/contact">お問い合わせフォーム</Link>
                  の種別「事業者情報の開示請求」をお選びのうえお送りください。
                </span>
              </td>
            </tr>
            <tr>
        ...
        <table className="spec-table">
          <tbody>
            ...
            <tr>
              <th>業者向けの料金</th>
              <td>
                登録業者向けの料金・契約条件は、業者登録のお申し込み後に個別にご案内します（本ページには掲載していません）。
                <br />
                <span className="note">
                  ※ ユーザー（出品者）の費用は無料です。
                </span>
