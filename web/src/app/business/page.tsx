...
const STATS: { num: string; unit: string; label: string }[] = [
  ...
  { num: "上位", unit: "3社", label: "に絞られた交渉機会" },
];
...
const MERITS: { n: string; tag: string; tagColor: "green" | "blue" | "gold"; h: string; p: string; d?: 1 | 2 }[] = [
  ...
  { n: "02", tag: "透明", tagColor: "blue", h: "写真査定で、下見コスト不要", p: "出品情報は写真と品目で構成。現物確認の前に買取総額の入札ができるため、下見の移動コストがかかりません。入札した上位3社だけが交渉に進めます。", d: 1 },
  ...
  { n: "04", tag: "安心", tagColor: "blue", h: "営業電話の一斉架電なし", p: "ユーザーへの連絡は上位3社のみ。無駄な電話をかける必要がなく、交渉に進んだユーザーとだけ丁寧にやりとりできます。信頼関係を築きやすい環境です。" },
...
const FLOW: { n: string; icon: "camera" | "yen" | "chat" | "truck"; h: string; p: string; d?: 1 | 2 | 3 }[] = [
  ...
  { n: "3", icon: "chat", h: "上位3社として交渉", p: "上位3社に入れば連絡先が開示されユーザーと交渉。条件を調整して成約へ。", d: 2 },
...
const FAQ_ITEMS = [
  ...
  { q: "入札した案件はすべて交渉できますか？", a: "入札額の上位3社のみユーザーとの交渉に進めます。4位以下の入札は自動でお断りとなり、ユーザーへの連絡はできません。" },
        ...
        <section className="biz-hero">
          <div className="container">
            ...
            <p className="hero-sub">
              個人が家じゅうの不用品をまとめて出品。業者は写真だけで買取総額を入札し、上位3社だけがユーザーと交渉できます。下見なし・一斉架電なし・まとめて効率的な仕入れ。費用は成約時の
