...
const STATS: { num: string; unit: string; label: string }[] = [
  /* R4 E.2-2: 業者が最初に見る数字を「下見0回」にする（下見の空振りが最大の痛点のため）。
     2026-09-18: 業者向け料金は公開ページに載せない方針のため「初期費用・月額費用 0円」「手数料 8%」の 2 項目を外した。 */
...
const ASSURANCES: { n: string; h: string; p: string }[] = [
  ...
  },
  {
    n: "05",
    h: "料金・契約条件は個別にご案内",
    p: "業者向けの料金・契約条件は、業者登録のお申し込み後に個別にご案内します。このページには掲載していません。",
  },
  {
    n: "06",
...
const FAQ_ITEMS = [
  { q: "料金はいくらですか？", a: "業者向けの料金・契約条件は、業者登録のお申し込み後に個別にご案内します。このページには掲載していません。" },
  ...
  // r10 H2 是正: 業者向けの支払いの説明がどこにも無かった。
  // 代金の流れ（当事者間か・カタヅケ経由か）は決済方針の確定（法務確認後）まで断定しない。
  { q: "買取代金はどのように支払いますか？", a: "お支払い方法は、成約後にご案内します。" },
  ...
  return (
    <div className="business-page bare-scope">
      ...
      <main id="main">
            ...
            <div className="media-split media-split--rev biz-hero-split">
              ...
              <div className="biz-hero-copy">
                ...
                <p className="hero-sub">
                  ...
                  <br />
                  料金・契約条件は、業者登録のお申し込み後に個別にご案内します。
                </p>
        ...
        <section className="biz-beta" aria-label="サービスの状況">
          <div className="container">
        ...
        {/* ============ 参加のモデルケース（架空） ============
            ...
            ⑤（旧）成約手数料の行 .vc-fee は、料金を公開ページに載せない方針のため 2026-09-18 に撤去。 */}
              ...
              {!submitted ? (
                <form onSubmit={onSubmit} noValidate>
                    ...
                    <div className="field-row">
                      ...
                      <div className="field">
                        <label htmlFor="registered-address">
                          所在地（法人は本店、個人事業主は事業所）<span className="req">必須</span>
                        </label>
                        <input
                          type="text"
                  ...
                  <div className="biz-bank-section">
                    ...
                    <p className="biz-bank-lead">
                      精算（返金が生じた場合の振込先を含む）のために、口座情報をお伺いします。
                      お申し込みの時点で請求が発生することはありません。料金・契約条件は個別にご案内します。
                    </p>
                ...
                <div className="thanks" style={{ display: "block" }}>
                  ...
                  <p>
                    ...
                    <br />
                    アカウント作成後、古物商許可証の画像をご提出いただき、運営の承認後に入札できるようになります。
                  </p>
