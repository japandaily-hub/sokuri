...
const MERITS: { n: string; tag: string; tagColor: "green" | "blue" | "gold"; h: string; p: string; d?: 1 | 2 }[] = [
  ...
  { n: "05", tag: "シンプル", tagColor: "green", h: "費用は成約時の8%のみ", p: "登録・掲載・入札はすべて無料。成約が決まった際に、買取金額の8%のみ手数料として発生します。それ以外の費用は一切かかりません。固定費ゼロで始められます。※ サービス開始当初（β期間）は手数料を請求しません。請求開始の際は事前にメールでお知らせします。", d: 1 },
...
const FAQ_ITEMS = [
  { q: "手数料はいくらですか？", a: "登録・掲載・入札はすべて無料です。費用が発生するのは成約時のみで、買取金額の8%が手数料として発生します。それ以外の費用は一切かかりません。なお、サービス開始当初（β期間）は手数料を請求しません。請求開始の際は事前にメールでお知らせします。" },
              ...
              {!submitted ? (
                ...
                <div className="thanks" style={{ display: "block" }}>
                  ...
                  <p>
                    ...
                    <br />
                    承認時は招待コードをお送りしますので、そのコードで業者アカウントを作成してください。
                  </p>
