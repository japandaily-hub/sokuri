...
export const metadata: Metadata = {
  ...
  description:
    "家じゅうの不用品を、まとめて撮って待つだけ。登録業者が“買取総額”で競い合い、連絡が来るのは上位3社だけ。値がつかない物もまとめて回収。営業電話に追われない、家まるごとの片付け買取マッチング。",
  keywords: [
    "片付け 買取",
    "不用品 買取",
    "まとめ 買取",
  ...
  openGraph: {
    ...
    description:
      "まとめて撮って待つだけ。業者が買取総額で競い合います。連絡は上位3社だけ。値がつかない物もまとめて回収。",
    images: [{ url: "/opengraph-image", width: 1200, height: 630, alt: "カタヅケ — 家まるごと片付け買取" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "カタヅケ — 家まるごと、まとめて片付け買取",
    description: "まとめて撮って待つだけ。業者が買取総額で競い合います。連絡は上位3社だけ。",
