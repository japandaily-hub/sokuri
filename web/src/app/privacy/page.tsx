 ...
 *  （UserSignupRequest / CaseCreateRequest / OperatorSignupRequest / OperatorApplication）
 *  と整合させて記載すること。 */
    ...
    <main id="main">
      ...
      <div className="legal-body">
        ...
        <div className="note">
          ...
          査定段階で入札業者に提供されるのは、写真・品目・利用目的・地域（都道府県・市区町村）・住居情報（住居種別・間取り・階数・エレベーターの有無）と、これらに基づくAI要約です。ユーザーの詳細住所（番地・建物名など）と連絡用のメールアドレス（LINE連携のみの場合はLINEでの連絡のご案内）は、交渉が成立した業者にのみ開示され、それ以外の業者には一切渡りません。氏名・電話番号を業者に提供することはありません。
        </div>
